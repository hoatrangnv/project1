...
<!--                    <li class="treeview{{ Request::is('wallets/btc') || Request::is('wallets/btcwithdraw') || Request::is('wallets/buysellclp') ? ' active' : null }}">
            ...
            <li class="treeview{{ Request::is('news*') ? ' active' : null }}">
                ...
                <ul class="treeview-menu">
                    <li class="{{ Request::segment(2) === 'manage' ? 'active' : null }}"><a href="{{ url('mybonus/faststart') }}">{{ trans('adminlte_lang::default.manage') }}</a></li>
                    <li class="{{ Request::segment(2) === 'add' ? 'active' : null }}"><a href="{{ url('mybonus/binary') }}">{{ trans('adminlte_lang::default.add') }}</a></li>
                </ul>
            </li>
